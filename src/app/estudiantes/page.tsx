  ...
  return (
    <article className="flex flex-col gap-4">
      ...
      <section className="flex flex-col gap-1">
        ...
        <p>
          Para crear un estudiante es necesario ir a la sección de estudiantes y
        ...
        <p>
          ...
          finalizado, se debe hacer clic en{" "}
          <span className="font-medium">Crear estudiante.</span>
        </p>
        <p>
          Una vez creado el estudiante, deberás visualizar en la parte superior
          de tu pantalla un aviso de confirmación con el nombre del estudiante
          que acabas de crear:
        </p>
        <Image
          className="rounded-lg"
      ...
      <section className="flex flex-col gap-1">
        ...
        <p>
          ...
          de estudiantes y después hacer clic en el siguiente ícono, el cual
        ...
        <Image
          ...
          height={50}
        />
        <p>Al hacer clic, veremos la siguiente ventana emergente:</p>
        <Image
          className="rounded-lg"
        ...
        />
        <p>
          Lo primero será hacer clic en{" "}
          <span className="font-medium">Descargar plantilla de ejemplo,</span>{" "}
          lo que descargará un archivo de Excel el cual deberá ser rellenado con
        ...
        <ul className="px-8 list-disc">
          ...
          <li>email: Hace referencia al correo electrónico del estudiante.</li>
        ...
        <p>
          Una vez se hayan rellenado los datos de los estudiantes que se desean
          registrar, se deberá guardar el archivo y dirigirse nuevamente a la
          pantalla donde se descargó la plantilla. Esta vez haremos clic en{" "}
          <span className="font-medium">Seleccionar archivo</span>,
          seleccionaremos el archivo de Excel que acabamos de guardar y daremos
          clic en Aceptar. Finalmente, daremos clic en el botón{" "}
          <span className="font-medium">Añadir usuarios.</span>
        </p>
        <p>
          Una vez subidos los estudiantes, deberás visualizar en la parte
          superior de tu pantalla un aviso de confirmación con el nombre de los
          estudiantes que acabas de registrar.
        </p>
      </section>
      ...
      <section className="flex flex-col gap-1">
        ...
        />
        <p>
          En esta tabla se encuentran los proyectos asignados al estudiante. En
          caso de ser un estudiante que no tiene ningún proyecto, la tabla se
          mostrará vacía. Los proyectos que aparecen en color negro son
          proyectos en los que participó el estudiante, y el proyecto que
      ...
      <section className="flex flex-col gap-1">
        ...
        <p>
          Al hacer clic en el ícono <HiPencil />
        </p>
        <p>
          serás redirigido a una página que contiene la información del
          estudiante. En esta página es posible editar la información del
          estudiante, así como borrar su registro.
        </p>
        <Image
          className="rounded-lg"
        ...
        <p>
          ...
          la información que se necesite modificar y luego dar clic en el botón{" "}
          ...
          los cambios efectuados en el detalle del estudiante.
        </p>
        ...
        <p>
          veremos un aviso preguntando si realmente deseas borrar el estudiante.
